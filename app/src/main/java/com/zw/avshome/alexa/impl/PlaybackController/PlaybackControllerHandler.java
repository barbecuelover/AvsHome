...
package com.zw.avshome.alexa.impl.PlaybackController;
...
//    private final ProgressHandler mProgressHandler;
    ...
    public PlaybackControllerHandler(Context context) {
        mContext = context;
