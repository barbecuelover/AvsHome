...
//                player.start();
        ...
        record.stop();
        record.release();
        /*add: snowboy stop recording,and alexa listening state is starting*/
        sendMessage(MsgEnum.MSG_SNOWBOY_STOP_AND_ALEXA_LISTENING,"Recording is Stoped");
        Log.d("ZHANGSHUO "+TAG,"Recording is Stoped");
